// Mainframe macro generated from application: /home/setsuna/programs/Modules/Module-Packages/ROOT/6.08.06/install/bin/root.exe
// By ROOT version 6.08/06 on 2017-07-14 20:47:09
...
void Style_Toby_3-NOSTATS()
{
   // Add the saved style to the current ROOT session.

   delete gROOT->GetStyle("Toby_3");

   TStyle *tmpStyle = new TStyle("Toby_3", "Style gamma V gamma");
